...
export const PRIVACY_LAST_MODIFIED_AT = new Date('2026-05-06T00:00:00.000Z');
export const TERMS_LAST_MODIFIED_AT = new Date('2026-05-06T00:00:00.000Z');
export const SECURITY_LAST_MODIFIED_AT = new Date('2026-05-06T00:00:00.000Z');
