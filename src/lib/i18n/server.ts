...
export const NAMESPACES = ['common', 'landing', 'mcp', 'privacy', 'security', 'terms'] as const;
export type TNamespace = (typeof NAMESPACES)[number];

const resources = {
	en: { common: enCommon, landing: enLanding, mcp: enMcp, privacy: enPrivacy, security: enSecurity, terms: enTerms },
	ru: { common: ruCommon, landing: ruLanding, mcp: ruMcp, privacy: ruPrivacy, security: ruSecurity, terms: ruTerms },
	ja: { common: jaCommon, landing: jaLanding, mcp: jaMcp, privacy: jaPrivacy, security: jaSecurity, terms: jaTerms },
	es: { common: esCommon, landing: esLanding, mcp: esMcp, privacy: esPrivacy, security: esSecurity, terms: esTerms },
